...
## Gucci Workflow / Harness Track (Planned)

This track focuses on turning Hermes WebUI from a chat surface into a workflow console for
research, Obsidian note creation, /posting, ShareNote distribution, and natural-language cron setup.

Priority areas:

- Workflow-native UX for Obsidian / posting / ShareNote
- Natural-language cron builder with preview and validation
- Harness engineering: preflight checks, artifact validation, retry / recovery
- Korean-first UX polish and premium themes (Cherry Blossom, Neo Brutalism, Gucci)
- GitHub-ready documentation for power-user workflows and deployment

Primary planning docs:

- `docs/specs/2026-04-06-gucci-webui-spec.md`
- `docs/plans/2026-04-06_hermes-webui-gucci-roadmap.md`
