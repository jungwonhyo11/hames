...
Hermes Web UI supports pluggable color themes. Multiple themes ship built-in,
including premium custom themes, and you can create your own with pure CSS — no Python changes needed.
...
| **Cherry Blossom / 벚꽃** | Soft pink workflow theme with blossom-toned surfaces and optional falling petals along the sidebar. |
| **Neo Brutalism / 네오브루탈리즘** | Loud, high-contrast theme with heavy borders, hard shadows, and playful blocky UI energy. |
| **Gucci / 구찌 스타일** | Dark luxury theme with deep green-black surfaces, gold highlights, and fashion-inspired stripe accents. |
